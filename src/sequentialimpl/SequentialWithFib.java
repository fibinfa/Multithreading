...
/**
 * This class implements the sequential version(with fibonacci implementation)
 * of the program that calculates the average TMAX temperature for each station
 * from the climate data provided by NOAA. It takes the location of file as
 * input and outputs the average TMAX temperature along with min, max and avg
 * running time for 10 iterations
 * 
 * @author fibin
 *
 */
public class SequentialWithFib {
	 ...
	 * station.Additionally, Fibonnaci(17) is calcuted at the time of updating accum
	 * data structure. It then calculates the average per station.
	 * 
	 * @param inputList
