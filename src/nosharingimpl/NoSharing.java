...
public class NoSharing {
	public Map<String, Float> getAvgTempPerStation(List<String> inputList) {
		...
		Thread t1 = new Thread(new Runner(1, inputForThread1, accumMapForThread1, false));
		Thread t2 = new Thread(new Runner(2, inputForThread2, accumMapForThread2, false));
		Thread t3 = new Thread(new Runner(3, inputForThread3, accumMapForThread3, false));
