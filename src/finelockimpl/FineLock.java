 ...
 * threads are spawned but and fine grained synchronisation is introduced.
 * 
 * @author fibin
 *
 */
public class FineLock {
	...
	public Map<String, Float> getAvgTempPerStation(List<String> inputList) {
		...
		Thread t1 = new Thread(new Runner(inputForThread1, 1, accumMapShared, false, dummyObj));
		Thread t2 = new Thread(new Runner(inputForThread2, 2, accumMapShared, false, dummyObj));
		Thread t3 = new Thread(new Runner(inputForThread3, 3, accumMapShared, false, dummyObj));
